...
use The6FallenAngel\Variza\PaymentEvent;
...
final class PaymentEventTest extends TestCase
{
    ...
    {
        $this->assertTrue(PaymentEvent::fromJson('{"event":"payment.paid","slug":"x","attempt_code":"1","amount":1000,"status":"paid","sent_at":"2026-08-14T12:00:00+03:30"}')->isPaymentPaid());
        $this->assertFalse(PaymentEvent::fromJson('{"event":"other","slug":"x","attempt_code":"1","amount":1000,"status":"paid","sent_at":"2026-08-14T12:00:00+03:30"}')->isPaymentPaid());
    }
}
